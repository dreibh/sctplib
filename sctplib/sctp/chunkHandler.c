...
#endif                          /* SIN6_LEN */
                memcpy(&(tmp_su.sin6.sin6_addr.s6_addr),&(address->dest_addr.sctp_ipv6), sizeof(struct sockaddr_in6));
...
static void enterChunk(SCTP_simple_chunk * chunk, char *log_text)
{
    unsigned int cid;
